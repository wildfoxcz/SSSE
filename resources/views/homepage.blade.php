        ...
        <div class="slick-person-container">
            <div class="slick-slider slick-person-img slider-nav" data-slick='{"slidesToShow":3,"arrows":false,"asNavFor":".slider-for","focusOnSelect":true,"centerMode":true,"centerPadding":"0px"}'>
                @foreach($reviews as $review)
                    <div class="slick-content"><img src="{{ url('images/reviews/'.$review->image) }}" alt="" width="135" height="135"/>
                    </div>
                @endforeach
            </div>
                ...
                @foreach($reviews as $review)
                    <div class="slick-content">
                        ...
                        <blockquote class="quote quote-simple">
                            <q class="quote-text">{{ $review->content }}</q>
                            <cite class="quote-cite h6">{{ $review->name }}r</cite>
                            <div class="quote-meta">{{ $review->subtitle }}</div>
                        </blockquote>
                    </div>
                @endforeach
            </div>
